...
import {AiReportDisplay} from '../../Analytics/components';
    ...
    return (
      <div className="mb-6 bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200/50 p-8">
        <div className="text-center">
          {/* 로딩 인디케이터 */}
          <div
            className="w-16 h-16 bg-gradient-to-r from-purple-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-6 animate-pulse">
