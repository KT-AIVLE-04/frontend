  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error.response?.data?.message) {
        setAllErrors({
          name: error.response.data.message.includes("매장명")
            ? error.response.data.message
            : "",
          address: error.response.data.message.includes("주소")
            ? error.response.data.message
            : "",
          phoneNumber: error.response.data.message.includes("연락처")
            ? error.response.data.message
            : "",
          industry: error.response.data.message.includes("업종")
            ? error.response.data.message
            : "",
        });
      }
