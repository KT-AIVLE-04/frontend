...
export const handlers = [
  ...
  http.get(`${API_BASE_URL}/api/analytics/realtime/posts/report`, ({ request }) => {
    ...
    const markdownReport = `# 게시물 분석 보고서
...
## 인사이트
### 강점
1. **높은 참여율**: 평균 대비 1.5배 높은 참여율을 보이고 있습니다.
2. **긍정적 반응**: 댓글의 60%가 긍정적인 반응을 보이고 있습니다.
3. **키워드 다양성**: 다양한 긍정 키워드가 나타나 콘텐츠의 호응도가 높습니다.

### 개선점
1. **도달률 개선**: 더 많은 사용자에게 도달할 수 있는 전략이 필요합니다.
2. **부정 댓글 관리**: 10%의 부정 댓글에 대한 적극적인 대응이 필요합니다.

## 권장사항
1. **콘텐츠 전략**: 현재 콘텐츠 방향을 유지하되, 도달률 향상을 위한 해시태그 최적화를 권장합니다.
2. **댓글 관리**: 부정 댓글에 대한 신속한 대응과 긍정 댓글에 대한 적극적인 소통을 권장합니다.
3. **게시 시간**: 현재 게시 시간이 최적화되어 있으므로 유지하시기 바랍니다.

## 결론
전반적으로 긍정적인 반응을 보이고 있으며, 특히 참여율과 긍정적 댓글 비율이 우수합니다. 도달률 개선과 부정 댓글 관리에 집중하면 더욱 좋은 성과를 기대할 수 있습니다.`;
