...
export function ContentCard({ 
  ...
  const isVideo = content.contentType?.startsWith('video/') || content.type === 'video';
  const isImage = content.contentType?.startsWith('image/') || content.type === 'image';
    ...
    >
      ...
      <div className="p-6">
        ...
        <div className="flex justify-between items-center text-xs text-gray-500 mb-4 font-bold">
          ...
          <div className="">
            <span className={`px-2 py-1 text-xs font-black rounded-full border-2 ${
              isVideo 
