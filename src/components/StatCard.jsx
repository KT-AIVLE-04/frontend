...
export function StatCard({ title, value, icon, change, trend, yesterdayValue, className = '' }) {
  return (
    <Container variant="hover" className={`p-6 ${className}`}>
      <div className="flex justify-between items-start mb-4">
        ...
        {change && (
          <div className={`flex items-center font-bold ${trend === 'up' ? 'text-green-600' : trend === 'down' ? 'text-red-600' : 'text-gray-600'}`}>
